var controladorAnimationPlural = /** @class */ (function () {
    function controladorAnimationPlural(selector, duracion, config, prefab, dA, interpolacion, keyFrameUno, keyFrameDos) {
            ...
            if (this.prefab == null) {
                ...
                for (var i = 0; i < this.selector.length; i++) {
                    ...
                    if (this.prefab == 'fadein') {
                        ...
                        setTimeout(function () { for (var i = 0; i < elemento_A_Animar.length; i++) {
                            var elChild = elemento_A_Animar[i];
...
var creacionDeElemento = /** @class */ (function () {
    function creacionDeElemento(elemento, src, selector) {
        this.elemento = elemento;
        this.src = src;
        this.selector = selector;
    }
    creacionDeElemento.prototype.crearModal = function () {
...
function asignarAnimacion(selector, duracion, config, prefab, dA, interpolacion, keyFrameUno, keyFrameDos) {
